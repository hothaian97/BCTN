...
namespace WebSportOnline.Models
{
    public class DonhangKHModel
    {
        ...
        {
            using (AnSportEntities db = new AnSportEntities())
            {
        ...
        private void Luuchitietdonhang(Giohang giohang, AnSportEntities db, string maDH)
        {
